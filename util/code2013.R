...
data2013=read.csv("monitoring2013.csv", sep=";", dec= "," , 
...
write.table(weeds2013C1, "Data-Prog/weeds2013.csv", sep = ";")

###########################################
## Aggregation des especes
###########################################
#weeds<-weeds2013C1
weeds<-read.csv("Data-Prog/weeds2013.csv", sep = ";",dec=",")
...
#head(A, 25)
write.table(A, "Data-Prog/transpose_abondance_per_quadrat2013.csv", sep = ";")
...
write.table(test, "Data-Prog/transpose_abondance_per_fieldcore2013.csv", sep = ";")
...
write.table(test, "Data-Prog/transpose_abondance_per_field2013.csv", sep = ";")
...
A=read.csv("Data-Prog/transpose_abondance_per_fieldcore2013.csv", sep = ";",h=T)
...
##Etape 1: estimation de la richesse observée sur 40 m²
A=read.csv("Data-Prog/transpose_abondance_per_quadrat2013.csv", sep = ";",h=T)
...
write.table(A_Diversity, "Data-Prog/Diversity_fieldcore2013.csv", sep = ";")
