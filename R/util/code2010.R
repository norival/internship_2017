...
###length(unique(weeds2010$Espece_origin))
## 294 espèces soit 294 colonnes dans la matrice

weeds2010C1 <- cbind(weeds2010C, as.factor(weeds2010C$Espece_origin))
...
write.csv(abond_per_plot, "data/generated/abondt_per_quadra_2010.csv",
          row.names = TRUE)
